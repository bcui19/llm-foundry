...
from llmfoundry.command_utils.vllm_utils import create_vllm_engines, init_process_group
...
if __name__ == "__main__":
    ...
    # if os.getenv('')
        ...
        print ("Ray debug log level is: ", os.getenv('RAY_BACKEND_LOG_LEVEL', None))
        print ("CUDA visible devices is: ", os.getenv('CUDA_VISIBLE_DEVICES', None))
        ...
        for i in range(len(vllm_engines)):
            ...
            print(
                ray.get(
                    vllm_engines[i].generate.
                    remote('Hi there how are you?'),
                ),
            )
