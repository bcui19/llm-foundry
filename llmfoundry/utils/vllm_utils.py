...
from llmfoundry.utils.vllm_ray import LLMRayActor
...
class WorkerWrap(Worker):
    ...
    def init_process_group(
        ...
        self.rank = rank
        print('init process group for: ', torch.distributed.get_rank())
        print(
    ...
    def update_weight(self, name, dtype, shape, empty_cache=False):
        ...
        print('updating weight for rank: ', self.rank)
        print('updating weight for distributed rank', self.rank)
...
def print_debug_info():
    ...
    # -- Check flashattn-hopper installation --
    try:
        import importlib.metadata
        try:
            flash_version = importlib.metadata.version("flashattn-hopper")
            print("=== FLASHATTN-HOPPER PACKAGE CHECK ===")
            print("flashattn-hopper version:", flash_version)
        except importlib.metadata.PackageNotFoundError:
            print("flashattn-hopper is not installed.")
    except ImportError:
        print("importlib.metadata not available. Cannot check flashattn-hopper version.")
    print()
    ...
    try:
        ...
        print("`nvidia-smi` not found. Is the NVIDIA driver installed or accessible?")
